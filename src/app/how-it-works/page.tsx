...
function Stat({ value, label }: { value: string; label: string }) {
  return (
    <div className="rounded-2xl border border-outline-variant/30 bg-surface-mid px-5 py-4">
  ...
  return (
    <main className="flex-1">
      <div className="mx-auto max-w-3xl px-6 py-16 sm:py-24">
        <Link
          href="/"
          className="text-sm text-on-surface-variant underline underline-offset-4 transition hover:text-on-surface"
        >
          ← Back to the practice site
        </Link>

        <p className="mt-10 text-sm font-medium tracking-wide text-primary uppercase">
          Portfolio demo
        </p>
        ...
        <section className="mt-16">
          ...
          <p className="mt-4 leading-relaxed text-on-surface-variant">
            ...
            comes back with a similarity of <strong className="text-on-surface">0.476</strong> &mdash;
        ...
        <section className="mt-14">
          ...
          <p className="mt-4 leading-relaxed text-on-surface-variant">
            The second suite is the release gate: <strong className="text-on-surface">all fifteen must
        ...
        <section className="mt-14 rounded-2xl border border-outline-variant/30 bg-surface-low p-6">
        ...
        <footer className="mt-14 border-t border-outline-variant/30 pt-6 text-sm text-on-surface-variant/60">
          <p>
          ...
          <p className="mt-4">
            <Link href="/" className="underline underline-offset-4 hover:text-on-surface">
              ← Back to the practice site
            </Link>
          </p>
        </footer>
